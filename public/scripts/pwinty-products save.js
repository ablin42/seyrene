...
const glazeType = {
    ACRY: "Acrylic / Perspex",
    GLA: "Float Glass",
    TRU: "Tru View Museum Glass"
}
...
class PwintyObject {
    constructor(item) {
        ...
        Object.keys(attr).forEach(attrib => {
            console.log(attrib);
            for (let i = 0; i < Object.keys(attr[attrib]).length; i++) {
                console.log(Object.keys(attr[attrib])[i], Object.values(attr[attrib])[i]);
            }
        })
