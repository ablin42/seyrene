				...
				if ($(`#${id}`).length === 0) {
					...
					toAppend = `
									<div class="face face1 blog-overlay-wrapper mt-0">
										<a href="#expand">
											<img data-imgid="${gallery.mainImgId}" src="${gallery.mainImgPath}" class="w-100 expandable" alt="Gallery Painting - ${gallery.shorttitle}">
										</a>
									
									<div class="blog-overlay expandable" data-id="${gallery._id}" data-isGallery="true">
