class SmoothScroll {
	constructor(_containerSelector, _params) {
		...
		this.$ = {
			...
			containerBody: document.querySelector(_containerSelector),
			hitbox: document.querySelector(_containerSelector),
		...
		console.log(document.querySelector(_containerSelector), document.querySelector(_containerSelector + "__body"));
...
new SmoothScroll("#body-smooth", params);
